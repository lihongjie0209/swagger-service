module github.com/lihongjie0209/swagger-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.1.2
	github.com/lihongjie0209/platform-protos v0.1.0
