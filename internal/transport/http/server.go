...
import (
	...
	"github.com/lihongjie0209/swagger-service/internal/ratelimit"
...
var Module = fx.Module("http", fx.Provide(auth.NewRuntime, health.New, ratelimit.New, NewHandler, NewSwaggerHandler, NewServer), fx.Invoke(func(*http.Server) {}))
